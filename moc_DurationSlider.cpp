...
#include <memory>
#include "Interfaccia/DurationSlider.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DurationSlider_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_DurationSlider_t qt_meta_stringdata_DurationSlider = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_DurationSlider[] = {
...
Q_CONSTINIT const QMetaObject DurationSlider::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DurationSlider.offsetsAndSizes,
    qt_meta_data_DurationSlider,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_DurationSlider_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DurationSlider, std::true_type>
    >,
    nullptr
} };
